...
- **Extendable Implementation**: This code base is built on FairSeq, which allows for highly distributed training, and Huggingface Transformers, which make it easy to swap out text and image models for other domain-specific variants and bring in other modalities. 
