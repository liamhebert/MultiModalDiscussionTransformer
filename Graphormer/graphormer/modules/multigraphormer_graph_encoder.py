...
class MultiGraphormerGraphEncoder(nn.Module):
    def __init__(
        ...
        self.vit_model, self.vit_pooler, vit_other_layers, self.bert_model, self.bert_pooler, bert_other_layers, self.bert_classifier, self.bert_dropout = self.build_vit_bert_encoders(num_fusion_layers + 1)
