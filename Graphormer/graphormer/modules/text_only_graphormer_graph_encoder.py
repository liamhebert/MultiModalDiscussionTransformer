...
class TextGraphormerGraphEncoder(nn.Module):
    def __init__(
        self,
        num_atoms: int,
        num_in_degree: int,
        ...
        text_encoder: str = 'bert-base-cased',
        ...
        self.bert_model = self.build_bert_encoders(text_encoder)
        ...
        #self.num_bottle_neck = 1
        #self.bottle_neck = nn.Embedding(1, 768)
        ...
        self.grad_context = nullcontext if freeze_language_model else torch.no_grad

    def build_bert_encoders(self, bert_encoder):
        ...
        bert_model = AutoModel.from_pretrained(bert_encoder)
    ...
    def forward(
        ...
        graph_rep = inner_states[-1]
        graph_rep = graph_rep.transpose(0, 1)
        graph_rep = graph_rep[mask, :]
