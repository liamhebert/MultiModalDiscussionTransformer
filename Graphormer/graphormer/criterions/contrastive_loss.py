...
class GraphPredictionContrastiveLoss(FairseqCriterion):
    """
    Implementation for the contrastive loss used in graphormer model training.
    """
    ...
    def forward(self, model, sample, reduce=True):
        ...
        logits = logits[:, 0, :] # graph rep (batch x logit)
...
@register_criterion("contrastive_flag", dataclass=FairseqDataclass)
class GraphPredictionContrastiveLossWithFlag(GraphPredictionContrastiveLoss):
    """
