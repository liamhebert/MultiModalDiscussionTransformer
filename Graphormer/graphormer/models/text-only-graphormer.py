...
from ..modules import init_graphormer_params, TextGraphormerGraphEncoder
...
@register_model("text_graphormer")
class GraphormerModel(FairseqEncoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            "--text_encoder",
            type=str,
            help="text encoder to use to encode comments",
        )
        ...
        parser.add_argument(
            ...
            action="store_true",
            help="prevent backprop to language model"
        )
...
class GraphormerEncoder(FairseqEncoder):
    def __init__(self, args):
        ...
        self.graph_encoder = TextGraphormerGraphEncoder(
            # < for graphormer
            ...
            freeze_language_model=args.freeze_lang_model
        )
...
@register_model_architecture("text_graphormer", "text_graphormer")
def base_architecture(args):
    ...
    args.freeze_lang_model = getattr(args, "freeze-language-model", False)
    args.apply_graphormer_init = getattr(args, "apply_graphormer_init", False)
    args.text_encoder = getattr(args, "text_encoder", "bert-base-cased")
    args.activation_fn = getattr(args, "activation_fn", "gelu")
    args.encoder_normalize_before = getattr(args, "encoder_normalize_before", True)


@register_model_architecture("text_graphormer", "text_graphormer_base")
...
@register_model_architecture("text_graphormer", "text_graphormer_slim")
...
@register_model_architecture("text_graphormer", "text_graphormer_large")
