...
from ..modules import init_graphormer_params, GraphormerGraphEncoder, MultiGraphormerGraphEncoder
...
class GraphormerModel(FairseqEncoderModel):
    def __init__(self, args, encoder):
        ...
        if getattr(args, "apply_graphormer_init", False):
            print("I AM DOING THE BAD INIT THING")
...
class GraphormerEncoder(FairseqEncoder):
    def __init__(self, args):
        ...
        #self.model = AutoModelForSequenceClassification.from_pretrained('../../fine_tuned_text_model')
        self.lm_output_learned_bias = None
    ...
    def forward(self, batched_data, perturb=None, masked_tokens=None, **unused):
        # inner_states, bert_cls, vit_cls = self.graph_encoder(
        #     batched_data,
        #     perturb=perturb,
        # )
        ...
        #bert_cls = self.model(batched_data)
        #     batched_data,
        #     perturb=perturb,
        # )
...
@register_model_architecture("multi_graphormer", "multi_graphormer_slim")
...
@register_model_architecture("multi_graphormer", "multi_graphormer_large")
