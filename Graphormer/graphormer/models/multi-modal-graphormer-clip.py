...
from ..modules import init_graphormer_params, GraphormerGraphEncoder, MultiGraphormerGraphEncoder, MultiGraphormerGraphEncoderCLIP
...
@register_model("multi_graphormer_clip")
class GraphormerModel(FairseqEncoderModel):
    ...
    def build_model(cls, args, task):
        ...
        encoder = GraphormerEncoderCLIP(args)
...
class GraphormerEncoderCLIP(FairseqEncoder):
    def __init__(self, args):
        super().__init__(dictionary=None)
        self.max_nodes = args.max_nodes

        self.graph_encoder = MultiGraphormerGraphEncoderCLIP(
            # < for graphormer
...
@register_model_architecture("multi_graphormer_clip", "multi_graphormer_clip")
...
@register_model_architecture("multi_graphormer_clip", "multi_graphorme_clip_base")
...
@register_model_architecture("multi_graphormer_clip", "multi_graphormer_clip_slim")
...
@register_model_architecture("multi_graphormer_clip", "multi_graphormer_clip_large")
